...
// Standalone fallback functions if WordPress is not loaded
if ( ! function_exists( 'esc_html' ) ) { function esc_html( $t ) { return htmlspecialchars( (string)$t, ENT_QUOTES, 'UTF-8' ); } }
if ( ! function_exists( 'esc_html__' ) ) { function esc_html__( $t, $d = '' ) { return htmlspecialchars( (string)$t, ENT_QUOTES, 'UTF-8' ); } }
...
$first_name     = ! empty( $record['first_name'] ) ? esc_html( $record['first_name'] ) : 'Customer';
